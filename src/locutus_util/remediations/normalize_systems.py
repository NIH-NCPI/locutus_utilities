...
def batch_search_concepts(keywords, ontologies, search_api_list=['umls','ols'], results_per_page=10, start_index=0):
    """
...
def main(project_id,database):
    ...
    # confirm = input("Update these map
    # pings? [y/N]: ").strip().lower()
